    ...
    <>
      ...
      <div className="flex-grow overflow-hidden rounded-lg">
        <ScrollArea className="h-full overflow-y-auto pr-3" type="always">
          {/* Demo Notice Banner */}
          <div className="mb-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg flex items-center gap-2 w-fit">
            <AlertCircle className="h-5 w-5 text-yellow-600" />
            <p className="text-sm text-yellow-700">
              This is a demo dashboard displaying example data. The actual
              dashboard will be integrated with real data in the production
              environment.
            </p>
          </div>
